...
const Creators = () => {
  return (
   <div className="max-w-[70vw] min-h-[62vh] mx-auto  my-8">
    <h1 className="text-5xl text-center jakarta-font-bold text-[#2e332e] my-2">Search Your Favourite Creators to Fund!</h1>
